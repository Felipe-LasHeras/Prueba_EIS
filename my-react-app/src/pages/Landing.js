    ...
    <div className="estilo-pagina">
      <div className="estilo-pagina">
        <section className="hero">
          <div className="container-hero">
            ...
            <div className="foto-principal">
              ...
              <div className="recuadro-foto-principal">
                <h1 className="texto-foto-principal">
                  THE ULTIMATE
                  <br />
                  DESSERT
                  <br />
        ...
        <section className="equipo">
          <div className="imagen-equipo-izquieda">
            <img src={equipo1} alt="" />
          </div>
          <div className="imagen-equipo-derecha">
            <img src={equipo2} alt="" />
          </div>
        </section>
        ...
        <section>
          ...
          <div className="imagen-derecha-signature">
            <img src={vasobeige} alt="" />
          </div>
        </section>
        <section>
          <div className="locoShakes">
            <div className="texo-titlulo-locoshakes">LOCOSHAKES</div>
            <div className="imagen-izquierda-locoshakes">
              <img src={cafelado} alt="" />
            </div>
            <div className="imagen-superior-derecha1-locoshakes">
              <img src={cafediagonal} alt="" />
            </div>
            <div className="imagen-superior-derecha2-locoshakes">
              <img src={cafearriba} alt="" />
            </div>
        ...
        <section>
          <div className="bakings">
            ...
            <div className="imagen-superior-derecha-bakings">
              <img src={pistacho} alt="" />
            </div>
            <div className="imagen-inferior-derecha-bakings">
              <img src={galleta} alt="" />
            </div>
          </div>
        </section>
        <section>
          <div className="desserts">
            ...
            <div className="imagen-izquierda-desserts">
              <img src={tiramisu} alt="" />
            </div>
            <div className="texto-pequeño-derecha-desserts"></div>
            <div className="imagen-derecha-desserts">
              <img src={wafflefrutilla} alt="" />
            </div>
          </div>
        </section>
        <section>
          <div className="coffee">
            ...
            <div className="texto-pequeño-derecha"></div>
            <div className="imagen-izquierda-coffee">
              <img src={cafegalleta} alt="" />
            </div>
            <div className="imagen-derecha-coffee">
              <img src={cafegalleta} alt="" />
            </div>
          </div>
        </section>
        ...
        <section className="connected">
          <div className="StayConnected">
            ...
            <div className="icono-izquierdo-connected">
              <img src={tazacafe} alt="" />
            </div>
            <div className="icono-centro-connected">
              <img src={vasobeige} alt="" />
            </div>
            <div className="icono-derecho-connected">
